...
public sealed class Caja : EntityBase
{
        ...
        : base(id, tenantId, createdAtUtc)
    {
        ...
        if (defaultMontoInicial < 0) throw new ArgumentException("DefaultMontoInicial must be >= 0.", nameof(defaultMontoInicial));

        SucursalId = sucursalId;
        Name = name;
        Numero = numero;
        DefaultMontoInicial = defaultMontoInicial;
        IsActive = isActive;
    }
    ...
    public decimal DefaultMontoInicial { get; private set; }
